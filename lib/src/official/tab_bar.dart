...
part of 'package:extended_tabs/src/extended/tab_bar.dart';
...
class _Tab extends StatelessWidget implements PreferredSizeWidget {
  ...
  ///
  /// If null, the height will be calculated based on the content of the [_Tab]. When `icon` is not
...
///
/// {@tool dartpad}
/// This sample shows the implementation of [_TabBar] and [TabBarView] using a [DefaultTabController].
/// Each [_Tab] corresponds to a child of the [TabBarView] in the order they are written.
///
/// ** See code in examples/api/lib/material/tabs/tab_bar.0.dart **
/// {@end-tool}
///
/// {@tool dartpad}
/// [_TabBar] can also be implemented by using a [TabController] which provides more options
/// to control the behavior of the [_TabBar] and [TabBarView]. This can be used instead of
...
///
/// {@tool dartpad}
/// This sample showcases nested Material 3 [_TabBar]s. It consists of a primary
/// [_TabBar] with nested a secondary [_TabBar]. The primary [_TabBar] uses a
/// [DefaultTabController] while the secondary [_TabBar] uses a [TabController].
///
...
///  * [TabController], which coordinates tab selection between a [_TabBar] and a [TabBarView].
...
class _TabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// See also:
  ///
  ///  * [_TabBar], for a primary tab bar.
  ///  * [TabBarView], which displays page views that correspond to each tab.
  ///  * [TabController], which coordinates tab selection between a [_TabBar] and a [TabBarView].
  ///  * https://m3.material.io/components/tab-bar/overview, the Material 3
  ///     tab bar specification.
  const _TabBar.secondary({
    super.key,
    required this.tabs,
    this.controller,
    this.isScrollable = false,
  ...
  /// Typically a list of two or more [_Tab] widgets.
  ///
  ...
  ///
  /// When [isScrollable] is false, this will yield the same result as if [_TabBar] was wrapped
  ...
  /// [MaterialState.selected] state, i.e. if the [_Tab] is selected or not,
  ...
  /// An optional callback that's called when the [_TabBar] is tapped.
  ///
  ...
  /// How the [_TabBar]'s scroll view should respond to user input.
  ///
  ...
  /// Returns whether the [_TabBar] contains a tab with both text and icon.
  ///
  /// [_TabBar] uses this to give uniform padding to all tabs in cases where
